...
public class AppController {
    ...
    public ResponseEntity<UserResponse> create(@PathVariable(name ="username") String username ) throws UserCreationException {
    	UserResponse usrRes= new UserResponse();
    	usrRes=appService.create(username);
    ...
    @GetMapping("/friend/{friendlistfor}")
